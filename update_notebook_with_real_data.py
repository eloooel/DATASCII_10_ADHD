...
if ablation_path.exists():
    ...
    print("Success: Real ablation results available!")
    print("\nData structure:")
...
if attention_path.exists():
    ...
    print("Success: Real attention weights available!")
    ...
    if 'fold_results' in results and len(results['fold_results']) > 0:
        ...
        if 'test_metrics' in fold:
            if 'probabilities' in fold['test_metrics']:
                ...
                print("Success: Predictions already in existing results!")
...
print("  Success: Real data from existing results (Figures 1-6, 9, 13, 14)")
print("  Success: Real ablation data (Figure 10) - just loaded!")
print("  Success: Real temporal attention (Figure 12) - just extracted!")
print("  Note: Synthetic ROC/PR curves (Figures 7-8) - based on real confusion matrices")
